...
Version  : 0.5.2
Release  : 40
URL      : https://cran.r-project.org/src/contrib/laeken_0.5.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/laeken_0.5.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633547622
